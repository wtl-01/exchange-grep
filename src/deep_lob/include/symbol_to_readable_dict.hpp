...
void saveDictionary(const std::unordered_map<std::string, std::string>& dictionary, const std::string& filename="symbol_to_readable.txt") {
...
void saveDictionaryToCSV(const std::unordered_map<std::string, std::unordered_map<std::string, std::string>>& dictionary, const std::string& filename="symbol_to_readable.txt") {
    std::ofstream file(filename);
    if (file.is_open()) {
